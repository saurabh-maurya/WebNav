...
public class updateSpeed extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            stmts.executeUpdate("UPDATE `speeddial` SET `URL`= '"+URL+"' ,`title`= '"+title+"' WHERE id="+id);
        ...
        response.sendRedirect("managespeed.jsp");
    }
}
