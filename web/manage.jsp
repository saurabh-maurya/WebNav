...
#customers th {
    ...
    <body>
        ...
        <div style="margin-top: 40px; " >
            <h3 style="">Delete Bookmark</h3>
            <form  class="deleteBookmark" action="deleteURL" method="POST">
                <input class="dBM" type="number" name="urldelete" placeholder="ID" required>
                <button class="dBM" type="submit" id="dlSub" class="btn btn-default btn-lg">DELETE</button>
            </form>
        </div>
        
        <div style="margin-top: 50px;">
            <h3 style="">Update Bookmark</h3>
            <form class="updateBookmark" action="updateURL" method="POST">
